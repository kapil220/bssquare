        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-20 text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif mb-6 leading-tight">
              <span className="block text-gray-900 font-normal mb-3">Get In</span>
              <span className="text-[#FFBD59] italic">Touch</span>
            </h1>
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border-b-2 border-gray-300 focus:border-[#FFBD59] focus:outline-none transition-colors duration-300"
                        placeholder="John"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="6"
                      className="w-full px-4 py-3 border-b-2 border-gray-300 focus:border-[#FFBD59] focus:outline-none transition-colors duration-300 resize-none"
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-serif mb-4 text-gray-900">
              Our <span className="text-[#FFBD59] italic">Offices</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              <div className="w-14 h-14 bg-[#FFBD59]/10 rounded-lg flex items-center justify-center mb-6">
                <MapPin className="text-[#FFBD59]" size={28} />
              </div>
              <h3 className="text-2xl font-serif text-gray-900 mb-4">UAE Office</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                Dubai, United Arab Emirates
              </p>
              <div className="space-y-2 text-sm text-gray-600">
                <p className="flex items-center gap-2">
                  <Phone size={16} className="text-[#FFBD59]" />
                  +971 56 226 0803
                </p>
                <p className="flex items-center gap-2">
            ...
            >
              ...
              <h3 className="text-2xl font-serif text-gray-900 mb-4">India Office</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
